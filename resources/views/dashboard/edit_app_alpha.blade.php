...
@section('content')
    ...
    <div id="meat-and-potatoes" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="padding-left: 245px" >
        <div class="col-md-3">
            ...
            {{ Form::model($app, array('route' => array('dashboard.edit_app_alpha', Auth::user()->username, $app_name ))) }}
        ...
        <div class="col-md-5">
            ...
            <h3> Add Screen:</h3>
            <br/>
            <form method="POST" action="{{ route('dashboard.edit_app_alpha', [Auth::user()->username, $app_name ]) }}" accept-charset="UTF-8">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2" style="padding-left: 245px" >
        <div class="col-md-4">
